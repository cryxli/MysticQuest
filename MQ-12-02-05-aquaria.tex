...
You can sleep in the inn in the southeastern corner for 96 Gold. There is also a trader selling \nameref{weapon:bomb}s for 10 Gold each. TODO as soon as the water crystal is freed, There is an additional trader behind the counter that sells \nameref{item:cure_potion}s for 100000 Gold each.
